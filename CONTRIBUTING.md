...
```
fix(shiki-highlight): handle custom divider inside tokenizer
```
...
- Keep runtime dependencies minimal. This package should stay lightweight and focused on highlight/tokenization logic.
